...
\section{El problema de la asignación cuadrática (QAP)}
    ...
    Al tratarse de un problema de minimización, la estrategia de poda que se sigue es podar cada rama en la que se encuentre una satisfacción mínima mayor que la satisfacción de la mejor solución encontrada hasta el momento. La estrategia de ramificación utilizada es Least-Cost FIFO, ya que buscamos el mínimo coste en una cola con prioridad.
