...
\section{Traveling Salesman Problem}
  ...
  La poda se realiza generando únicamente vectores que representen posibles soluciones, es decir, solo se consideran permutaciones del vector inicial $(1,\dots,n)$. De esta forma descartamos el resto de posibles combinaciones de los elementos.
