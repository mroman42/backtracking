...
fijo, y un conjunto de elementos que queremos almacenar en nuestro contenedor. Dichos elementos tendrán un peso 
determinado, y obtendremos un cierto beneficio por cada objeto almacenado. Nuestro objetivo es maximizar dicho 
beneficio, con la restricción de que la mochila solo puede llevar un peso máximo, determinado por su tamaño. 
